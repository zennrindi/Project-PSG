<div class="footer-copyright-area">
    ...
    <!-- morrisjs JS
        ============================================ -->
    <script src="<?php echo base_url('jeweler-master/'); ?>js/morrisjs/raphael-min.js"></script>
    <script src="<?php echo base_url('jeweler-master/'); ?>js/morrisjs/morris.js"></script>
    <script src="<?php echo base_url('jeweler-master/'); ?>js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
        ============================================ -->
    <script src="<?php echo base_url('jeweler-master/'); ?>js/sparkline/jquery.sparkline.min.js"></script>
    <script src="<?php echo base_url('jeweler-master/'); ?>js/sparkline/jquery.charts-sparkline.js"></script>
    <!-- calendar JS
        ============================================ -->
    <script src="<?php echo base_url('jeweler-master/'); ?>js/calendar/moment.min.js"></script>
    <script src="<?php echo base_url('jeweler-master/'); ?>js/calendar/fullcalendar.min.js"></script>
    <script src="<?php echo base_url('jeweler-master/'); ?>js/calendar/fullcalendar-active.js"></script>
    <!-- plugins JS
        ============================================ -->
